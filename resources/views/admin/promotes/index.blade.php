                    ...
                    <section class="wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="{{url('/admin/promotes/create')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                        ...
                                        <table class="table text-center">
                                                ...
                                                @foreach ($promote as $i)
                                                        <tr>
                                                            ...
                                                            <td>{{$i->updated_at}}</td>
                                                            <td>
                                                                <a href="{{url('/admin/promotes/edit/'.$i->promote_id)}}" class="btn btn-edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                            </td>
                                                            <td>
                                                                <a href="{{url('/admin/promotes/delete/'.$i->promote_id)}}" class="btn btn-danger">
