...
@section('content')
<head>
	<title>สมัครสมาชิกตลาดคอมฮาร์ดแวร์</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="{{route('register')}}">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter firstname">
						<input class="input100" type="text" name="firstname" placeholder="ชื่อจริง">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter email">
						<input class="input100" type="text" name="email" placeholder="อีเมล">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter password_confirmation">
						<input class="input100" type="password" name="password_confirmation" placeholder="ยืนยันรหัสผ่าน">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="{{route('login')}}">
							หากมีบัญชีแล้ว คุณสามารถล็อกอินได้ที่นี่
